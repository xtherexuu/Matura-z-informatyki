...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2026 at 12:10 AM
...
--
-- Struktura tabeli dla tabeli `kandydaci_txt`
--

CREATE TABLE `kandydaci_txt` (
  `idosoby` varchar(4) DEFAULT NULL,
  `imie` varchar(10) DEFAULT NULL,
  `nazwisko` varchar(11) DEFAULT NULL,
  `matematyka` int(3) DEFAULT NULL,
  `informatyka` int(3) DEFAULT NULL,
  `fizyka` int(3) DEFAULT NULL,
  `jezykobcy` int(3) DEFAULT NULL,
  `plec` varchar(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `kandydaci_txt`
--

INSERT INTO `kandydaci_txt` (`idosoby`, `imie`, `nazwisko`, `matematyka`, `informatyka`, `fizyka`, `jezykobcy`, `plec`) VALUES
...
--
-- Struktura tabeli dla tabeli `zgloszenia_txt`
--

CREATE TABLE `zgloszenia_txt` (
  `kierunek` varchar(15) DEFAULT NULL,
  `idosoby` varchar(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `zgloszenia_txt`
--

INSERT INTO `zgloszenia_txt` (`kierunek`, `idosoby`) VALUES
('fizyka', 'k116'),
('fizyka', 'k083'),
('elektronika', 'k056'),
('elektronika', 'k165'),
